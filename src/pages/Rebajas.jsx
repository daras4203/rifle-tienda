  ...
  <div className="col-md-4">
    <div className="producth-card men">
      ...
      <div id="carousel1" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img1.webp" className="d-block w-100" alt="Jean Hombre" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img1.2.webp" className="d-block w-100" alt="Jean Hombre" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <p>Estos jeans Classic fit con su silueta relajada y su lavado frosted, le dan un aire retro al estilo.</p>
        <div className="product-price">
          <span className="old-price">Antes: $149.900</span><br />
          <span className="new-price">Ahora: $99.900</span>
        </div>
        <a href="/partials/producto1rebajas.html" className="btn btn-dark mt-2 w-100">AGREGAR A LA BOLSA</a>
      </div>
    </div>
  </div>
  ...
  <div className="col-md-4">
    <div className="producth-card men">
      ...
      <div id="carousel2" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img2.webp" className="d-block w-100" alt="Camiseta Hombre" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img2.2.webp" className="d-block w-100" alt="Camiseta Hombre" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <p>Esta camisa tipo Resort redefine el estilo formal. Confeccionada en una mezcla ecológica</p>
        <div className="product-price">
          <span className="old-price">Antes: $139.900</span><br />
          <span className="new-price">Ahora: $111.920</span>
        </div>
        <a href="/partials/producto2rebajas.html" className="btn btn-dark mt-2 w-100">AGREGAR A LA BOLSA</a>
      </div>
    </div>
  </div>
  ...
  <div className="col-md-4">
    <div className="producth-card men">
      ...
      <div id="carousel3" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img4.webp" className="d-block w-100" alt="Camisa Hombre" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img4.2.webp" className="d-block w-100" alt="Camisa Hombre" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <p>Esta polo comfort fit en tejido piqué para hombre combina comodidad y estilo con detalles que marcan la diferencia.</p>
        <div className="product-price">
          <span className="old-price">Antes: $189.900</span><br />
          <span className="new-price">Ahora: $69.950</span>
        </div>
        <a href="/partials/producto3rebajas.html" className="btn btn-dark mt-2 w-100">AGREGAR A LA BOLSA</a>
      </div>
    </div>
  </div>
  ...
  <div className="col-md-4">
    <div className="producth-card women">
      ...
      <div id="carousel4" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img3.webp" className="d-block w-100" alt="Jean Mujer" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img3.2.webp" className="d-block w-100" alt="Jean Mujer" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <p>Este jean Wide  ajusta suavemente en la cadera y se amplía desde la rodilla.</p>
        <div className="product-price">
          <span className="old-price">Antes: $189.900</span><br />
  ...
  <div className="col-md-4">
    <div className="producth-card women">
      ...
      <div id="carousel5" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img5.webp" className="d-block w-100" alt="Falda Mujer" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img5.2.webp" className="d-block w-100" alt="Falda Mujer" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <p>Esta falda larga tipo columna para mujer, confeccionada en tejido de punto</p>
        <div className="product-price">
          <span className="old-price">Antes: $129.900</span><br />
  ...
  <div className="col-md-4">
    <div className="producth-card women">
      ...
      <div id="carousel6" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img6.webp" className="d-block w-100" alt="Jean Mujer" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img6.2.webp" className="d-block w-100" alt="Jean Mujer" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <div className="product-price">
          <span className="old-price">Antes: $109.900</span><br />
  ...
  <div className="col-md-4">
    <div className="producth-card men">
      ...
      <div id="carousel7" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img7.webp" className="d-block w-100" alt="Chaleco Hombre" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img7.2.webp" className="d-block w-100" alt="Chaleco Hombre" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <div className="product-price">
          <span className="old-price">Antes: $209.900</span><br />
  ...
  <div className="col-md-4">
    <div className="producth-card men">
      ...
      <div id="carousel8" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img9.webp" className="d-block w-100" alt="Camisa Hombre" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img9.2.webp" className="d-block w-100" alt="Camisa Hombre" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <p>Polo tejida estilo clásico.</p>
        <div className="product-price">
          <span className="old-price">Antes: $179.900</span><br />
  ...
  <div className="col-md-4">
    <div className="producth-card women">
      ...
      <div id="carousel9" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/public/catalogoRebajas/img8.webp" className="d-block w-100" alt="Short Mujer" />
          </div>
          <div className="carousel-item">
            <img src="/public/catalogoRebajas/img8.2.webp" className="d-block w-100" alt="Short Mujer" />
          </div>
        </div>
      ...
      <div className="product-info">
        ...
        <div className="product-price">
          <span className="old-price">Antes: $159.900</span><br />
