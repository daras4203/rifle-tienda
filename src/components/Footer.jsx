    ...
    <footer>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "15px" }}>
          ...
          {/* Carrito */}
          <a href="#" title="Carrito" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#ffffff" viewBox="0 0 24 24">
          ...
          {/* Usuario */}
          <a href="/partials/form.html" title="Iniciar sesión">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#ffffff" viewBox="0 0 24 24">
          ...
          {/* Camión */}
          <a href="#" title="Entregas" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#ffffff" viewBox="0 0 24 24">
        ...
        <div style={{ textAlign: "center" }}>
          <a href="/partials/nosotros.html" className="text-light text-decoration-none" target="_blank" rel="noopener noreferrer">
            Nosotros
          </a>
          <br />
          <a href="/partials/servicioAlCliente.html" className="text-light text-decoration-none" target="_blank" rel="noopener noreferrer">
            Servicio al Cliente
          </a>
          <br />
          <a href="https://www.magneto365.com/co/empresas/rifle" className="text-light text-decoration-none" target="_blank" rel="noopener noreferrer">
            Trabaja Con Nosotros
          </a>
          <br />
          <a href="/partials/encuentraNuestraTienda.html" className="text-light text-decoration-none" target="_blank" rel="noopener noreferrer">
            Encuentra nuestra tienda
          </a>
        </div>

        {/* Columna derecha: texto legal */}
        <div style={{ textAlign: "right", maxWidth: "340px", fontSize: "14px" }}>
          &copy; COMODIN S.A.S., NIT 800.069.933-6, Calle 14 No.52 A - 372, Medellín - Colombia.
        </div>
      </div>
    </footer>
    </>
